...
router.post("/", authenticateUser, checkStudentAccountAccess, authorizeRoles(STAFF_ROLES), createProctoringRecording);
router.get("/:id", authenticateUser, checkStudentAccountAccess, authorizeRoles(WITH_STUDENT), getProctoringRecording);
router.put("/:id", authenticateUser, checkStudentAccountAccess, authorizeRoles(STAFF_ROLES), updateProctoringRecording);
router.delete("/:id", authenticateUser, checkStudentAccountAccess, authorizeRoles(STAFF_ROLES), deleteProctoringRecording);
