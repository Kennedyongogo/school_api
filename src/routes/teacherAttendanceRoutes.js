...
router.post("/", authenticateUser, authorizeRoles(STAFF_ROLES), createTeacherAttendance);
...
router.delete("/:id", authenticateUser, authorizeRoles(STAFF_ROLES), deleteTeacherAttendance);
